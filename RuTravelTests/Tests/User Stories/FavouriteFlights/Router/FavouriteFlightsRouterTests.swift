//
//  FavouriteFlightsRouterTests.swift
//  RuTravel
//
...
final class FavouriteFlightsRouterTests: XCTestCase {

	// MARK: - Properties

    private var view: MockModuleTransitionable?
    private var router: FavouriteFlightsRouter?

    // MARK: - XCTestCase

    override func setUp() {
        super.setUp()
        router = FavouriteFlightsRouter()
