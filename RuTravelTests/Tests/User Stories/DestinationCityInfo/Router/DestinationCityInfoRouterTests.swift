//
//  DestinationCityInfoRouterTests.swift
//  RuTravel
//
...
final class DestinationCityInfoRouterTests: XCTestCase {

	// MARK: - Properties

    private var view: MockModuleTransitionable?
    private var router: DestinationCityInfoRouter?

    // MARK: - XCTestCase

    override func setUp() {
        super.setUp()
        router = DestinationCityInfoRouter()
